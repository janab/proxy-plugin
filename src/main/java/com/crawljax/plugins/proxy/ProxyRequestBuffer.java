...
/**
 * This class is a plugin for the WebScarab proxy. It buffers outgoing HTTP requests. Two buffers
 * are maintained, a local one and a complete one. When the local request buffer is fetched, the
...
public class ProxyRequestBuffer extends ProxyPlugin {
	...
	/**
	 * Set to true iff all requests should be buffered. This is used to get a list of all requests
	 * since the beginning of execution. Note: may require a large amount of memory.
	 */
	...
	/**
	 * Copy the contents of the local buffer into a new buffer, return the new buffer and empty the
	 * local buffer.
	 * 
